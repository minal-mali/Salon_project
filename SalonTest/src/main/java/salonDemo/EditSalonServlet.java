...
//
//        pw.println("Salon Name: <input type='text' name='salon_name' value='" + s.getSalon_name() + "'><br><br>");
//        pw.println("Owner Name: <input type='text' name='owner_name' value='" + s.getOwner_name() + "'><br><br>");
//        pw.println("Email: <input type='email' name='email' value='" + s.getEmail() + "'><br><br>");
//        pw.println("Phone: <input type='text' name='phone' value='" + s.getPhone() + "'><br><br>");
//        pw.println("Address: <input type='text' name='address' value='" + s.getAddress() + "'><br><br>");
//        pw.println("City: <input type='text' name='city' value='" + s.getCity() + "'><br><br>");
//        pw.println("Opening Time: <input type='time' name='opening_time' value='" + s.getOpening_time() + "'><br><br>");
//        pw.println("Closing Time: <input type='time' name='closing_time' value='" + s.getClosing_time() + "'><br><br>");
//        pw.println("Salon Type: <input type='text' name='salon_type' value='" + s.getSalon_type() + "'><br><br>");
//
